...
sports_data = [
    ...
    (14, 'Golf Pro', 'golf-pro', '🏌️', 'OWGR Points', 14, 'Men Rankings', 'Women Rankings'),
...
old_teams_raw = [
    ...
    (4,1,'Iga Swiatek','club','pl',1100,50,45,5,0),(4,2,'Aryna Sabalenka','club','by',1050,48,42,6,0),(4,3,'Coco Gauff','club','us',1000,45,38,7,0),(4,4,'Elena Rybakina','club','kz',950,42,35,7,0),(4,5,'Jessica Pegula','club','us',900,40,32,8,0),(4,6,'Marketa Vondrousova','club','cz',850,38,30,8,0),(4,7,'Zheng Qinwen','club','cn',800,36,28,8,0),(4,8,'Maria Sakkari','club','gr',750,34,25,9,0),(4,9,'Danielle Collins','club','us',700,32,22,10,0),(4,10,'Ostapenko','club','lv',650,30,18,12,0),
    # Boxing (11)
    (11,1,'Usyk','national','ua',100,30,25,0,0),(11,1,'Shields','club','us',100,30,25,0,0),
    # MMA (12)
    (12,1,'Makhachev','national','ru',100,30,25,0,0),(12,1,'Grasso','club','mx',100,30,25,0,0)
]

# Fill missing old sports (5,6,7,8,9,10) with basic data
for sid in [5,6,7,8,9,10]:
    for i, (code, name) in enumerate(countries):
        old_teams_raw.append((sid, i+1, f"{name} Team", 'national', code, 1000-i*10, 20, 15, 5, 0))
    for i, (code, name) in enumerate(countries):
        old_teams_raw.append((sid, i+1, f"{name} Pro", 'club', code, 900-i*10, 18, 14, 4, 0))
